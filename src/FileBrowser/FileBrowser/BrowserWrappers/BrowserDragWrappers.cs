...
namespace FileBrowser
{
	...
	/// </summary>
	class BrowserTVDragWrapper : IDropSource, IDisposable
	{
		#region Fields
	...
	delegate void DragEnterEventHandler(object sender, DragEnterEventArgs e);

	class DragEnterEventArgs : EventArgs
	{
