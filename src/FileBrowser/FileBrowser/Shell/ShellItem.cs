...
namespace ShellDll
{
	public sealed class ShellItem : IEnumerable, IDisposable, IComparable
	{
		...
		internal ShellItemCollection SubFiles
		{
			get { return subFiles; }
		}

		internal ShellItemCollection SubFolders
		{
		...
		{
			get { return filesExpanded; }
		}

		public bool FoldersExpanded
		{
			get { return foldersExpanded; }
		}

		public bool IsSystemFolder
		{
			get { return type == browser.SystemFolderName; }
		}
	...
	class ShellItemUpdateCondition
	{
	...
	class ShellItemCollection : IEnumerable
	{
