...
namespace FileBrowser
{
	...
	/// </summary>
	class BrowserTreeSorter : IComparer
	{
	...
	/// </summary>
	class BrowserListSorter : IComparer
	{
		#region IComparer Members
	...
	class BrowserComboBox : ToolStripComboBox
	{
		...
		private class ComboEditWindow : NativeWindow
		{
